...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function PT(t,e,n){let i=new Float32Array(Us),r=new O(0,1,0);return new Kn({name:"SphericalGaussianBlur",defines:{n:Us,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:rh(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function by(){return new Kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:rh(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function wy(){return new Kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rh(),fragmentShader:`
	...
	`}var nh=class extends Xn{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new sl(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Ba(5,5,5),s=new Kn({name:"CubemapFromEquirect",uniforms:Ds(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:_n,blending:Hi});s.uniforms.tEquirect.value=n;let a=new vn(r,s),o=n.minFilter;return n.minFilter===is&&(n.minFilter=nn),new cd(1,10,this).update(e,a),n.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){let s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(n,i,r);e.setRenderTarget(s)}};function IT(t){let e=new WeakMap,n=new WeakMap,i=null;function r(d,m=!1){return d==null?null:m?a(d):s(d)}function s(d){if(d&&d.isTexture){let m=d.mapping;if(m===dd||m===hd)if(e.has(d)){let _=e.get(d).texture;return o(_,d.mapping)}else{let _=d.image;if(_&&_.height>0){let b=new nh(_.height);return b.fromEquirectangularTexture(t,d),e.set(d,b),d.addEventListener("dispose",c),o(b.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){let m=d.mapping,_=m===dd||m===hd,b=m===ns||m===Ls;if(_||b){let g=n.get(d),u=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==u)return i===null&&(i=new th(t)),g=_?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,n.set(d,g),g.texture;if(g!==void 0)return g.texture;{let p=d.image;return _&&p&&p.height>0||b&&p&&l(p)?(i===null&&(i=new th(t)),g=_?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,n.set(d,g),d.addEventListener("dispose",h),g.texture):null}}}return d}function o(d,m){return m===dd?d.mapping=ns:m===hd&&(d.mapping=Ls),d}function l(d){let m=0,_=6;for(let b=0;b<_;b++)d[b]!==void 0&&m++;return m===_}function c(d){let m=d.target;m.removeEventListener("dispose",c);let _=e.get(m);_!==void 0&&(e.delete(m),_.dispose())}function h(d){let m=d.target;m.removeEventListener("dispose",h);let _=n.get(m);_!==void 0&&(n.delete(m),_.dispose())}function f(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function NT(t){let e={};function n(i){if(e[i]!==void 0)return e[i];let r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){let r=n(i);return r===null&&Gu("WebGLRenderer: "+i+" extension not supported."),r}}}function LT(t,e,n,i){let r={},s=new WeakMap;function a(f){let d=f.target;d.index!==null&&e.remove(d.index);for(let _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",a),delete r[d.id];let m=s.get(d);m&&(e.remove(m),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,n.memory.geometries--}function o(f,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,n.memory.geometries++),d}function l(f){let d=f.attributes;for(let m in d)e.update(d[m],t.ARRAY_BUFFER)}function c(f){let d=[],m=f.index,_=f.attributes.position,b=0;if(_===void 0)return;if(m!==null){let p=m.array;b=m.version;for(let y=0,M=p.length;y<M;y+=3){let T=p[y+0],E=p[y+1],R=p[y+2];d.push(T,E,E,R,R,T)}}else{let p=_.array;b=_.version;for(let y=0,M=p.length/3-1;y<M;y+=3){let T=y+0,E=y+1,R=y+2;d.push(T,E,E,R,R,T)}}let g=new(_.count>=65535?il:nl)(d,1);g.version=b;let u=s.get(f);u&&e.remove(u),s.set(f,g)}function h(f){let d=s.get(f);if(d){let m=f.index;m!==null&&d.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:h}}function DT(t,e,n){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,d){t.drawElements(i,d,s,f*a),n.update(d,i,1)}function c(f,d,m){m!==0&&(t.drawElementsInstanced(i,d,s,f*a,m),n.update(d,i,m))}function h(f,d,m){if(m===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,f,0,m);let b=0;for(let g=0;g<m;g++)b+=d[g];n.update(b,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function UT(t){let e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(n.calls++,a){case t.TRIANGLES:n.triangles+=o*(s/3);break;case t.LINES:n.lines+=o*(s/2);break;case t.LINE_STRIP:n.lines+=o*(s-1);break;case t.LINE_LOOP:n.lines+=o*s;break;case t.POINTS:n.points+=o*s;break;default:Oe("WebGLInfo: Unknown draw mode:",a);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function FT(t,e,n){let i=new WeakMap,r=new Lt;function s(a,o,l){let c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=h!==void 0?h.length:0,d=i.get(o);if(d===void 0||d.count!==f){let C=function(){R.dispose(),i.delete(o),o.removeEventListener("dispose",C)};d!==void 0&&d.texture.dispose();let m=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,g=o.morphAttributes.position||[],u=o.morphAttributes.normal||[],p=o.morphAttributes.color||[],y=0;m===!0&&(y=1),_===!0&&(y=2),b===!0&&(y=3);let M=o.attributes.position.count*y,T=1;M>e.maxTextureSize&&(T=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);let E=new Float32Array(M*T*4*f),R=new Qo(E,M,T,f);R.type=Ai,R.needsUpdate=!0;let x=y*4;for(let P=0;P<f;P++){let I=g[P],F=u[P],W=p[P],X=M*T*4*P;for(let U=0;U<I.count;U++){let V=U*x;m===!0&&(r.fromBufferAttribute(I,U),E[X+V+0]=r.x,E[X+V+1]=r.y,E[X+V+2]=r.z,E[X+V+3]=0),_===!0&&(r.fromBufferAttribute(F,U),E[X+V+4]=r.x,E[X+V+5]=r.y,E[X+V+6]=r.z,E[X+V+7]=0),b===!0&&(r.fromBufferAttribute(W,U),E[X+V+8]=r.x,E[X+V+9]=r.y,E[X+V+10]=r.z,E[X+V+11]=W.itemSize===4?r.w:1)}}d={count:f,texture:R,size:new dt(M,T)},i.set(o,d),o.addEventListener("dispose",C)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",a.morphTexture,n);else{let m=0;for(let b=0;b<c.length;b++)m+=c[b];let _=o.morphTargetsRelative?1:1-m;l.getUniforms().setValue(t,"morphTargetBaseInfluence",_),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",d.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",d.size)}return{update:s}}function kT(t,e,n,i,r){let s=new WeakMap;function a(c){let h=r.render.frame,f=c.geometry,d=e.get(c,f);if(s.get(d)!==h&&(e.update(d),s.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==h&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),s.set(c,h))),c.isSkinnedMesh){let m=c.skeleton;s.get(m)!==h&&(m.update(),s.set(m,h))}return d}function o(){s=new WeakMap}function l(c){let h=c.target;h.removeEventListener("dispose",l),i.releaseStatesOfObject(h),n.remove(h.instanceMatrix),h.instanceColor!==null&&n.remove(h.instanceColor)}return{update:a,dispose:o}}var OT={[Am]:"LINEAR_TONE_MAPPING",[Cm]:"REINHARD_TONE_MAPPING",[Rm]:"CINEON_TONE_MAPPING",[Pm]:"ACES_FILMIC_TONE_MAPPING",[Nm]:"AGX_TONE_MAPPING",[Lm]:"NEUTRAL_TONE_MAPPING",[Im]:"CUSTOM_TONE_MAPPING"};function BT(t,e,n,i,r){let s=new Xn(e,n,{type:t,depthBuffer:i,stencilBuffer:r,depthTexture:i?new gr(e,n):void 0}),a=new Xn(e,n,{type:Wi,depthBuffer:!1,stencilBuffer:!1}),o=new oi;o.setAttribute("position",new Yt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Yt([0,2,0,0,2,0],2));let l=new ju({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
#define LOW_PRECISION`),e}var HA={[ml]:"SHADOWMAP_TYPE_PCF",[Ga]:"SHADOWMAP_TYPE_VSM"};function WA(t){return HA[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var XA={[ns]:"ENVMAP_TYPE_CUBE",[Ls]:"ENVMAP_TYPE_CUBE",[gl]:"ENVMAP_TYPE_CUBE_UV"};function qA(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":XA[t.envMapMode]||"ENVMAP_TYPE_CUBE"}var KA={[Ls]:"ENVMAP_MODE_REFRACTION"};function $A(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":KA[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}var YA={[Tm]:"ENVMAP_BLENDING_MULTIPLY",[ny]:"ENVMAP_BLENDING_MIX",[iy]:"ENVMAP_BLENDING_ADD"};function jA(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":YA[t.combine]||"ENVMAP_BLENDING_NONE"}function ZA(t){let e=t.envMapCubeUVHeight;if(e===null)return null;let n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function JA(t,e,n,i){let r=t.getContext(),s=n.defines,a=n.vertexShader,o=n.fragmentShader,l=WA(n),c=qA(n),h=$A(n),f=jA(n),d=ZA(n),m=UA(n),_=FA(s),b=r.createProgram(),g,u,p=n.glslVersion?"#version "+n.glslVersion+`
`:"";n.isRawShaderMaterial?(g=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,_].filter(Al).join(`
`),g.length>0&&(g+=`
`),u=["#define SHADER_TYPE "+n.shaderType,"#define SHADER_NAME "+n.shaderName,_].filter(Al).join(`
`),u.length>0&&(u+=`
...
`].filter(Al).join(`
`)),a=rg(a),a=Dy(a,n),a=Uy(a,n),o=rg(o),o=Dy(o,n),o=Uy(o,n),a=Fy(a),o=Fy(o),n.isRawShaderMaterial!==!0&&(p=`#version 300 es
...
`)+`
`+u);let y=p+g+a,M=p+u+o,T=Iy(r,r.VERTEX_SHADER,y),E=Iy(r,r.FRAGMENT_SHADER,M);r.attachShader(b,T),r.attachShader(b,E),n.index0AttributeName!==void 0?r.bindAttribLocation(b,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function R(I){if(t.debug.checkShaderErrors){let F=r.getProgramInfoLog(b)||"",W=r.getShaderInfoLog(T)||"",X=r.getShaderInfoLog(E)||"",U=F.trim(),V=W.trim(),G=X.trim(),Z=!0,te=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(Z=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,b,T,E);else{let ae=Ly(r,T,"vertex"),xe=Ly(r,E,"fragment");Oe("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
